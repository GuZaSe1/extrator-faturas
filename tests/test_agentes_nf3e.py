...
def fDadosFaturaVazios():
    return agentes_nf3e.DadosFatura(
        chave_acesso=None,
        num_cnpj_emit=None,
        num_cnpj_dest=None,
        num_nf=None,
...
class TesteOrquestracao(unittest.TestCase):
    ...
    def test_aprovacao_gera_envelope_completo(self):
        extrator = AgenteFalso(fDadosFaturaVazios())
        ...
        self.assertEqual("qwen2.5:14b", resultado["metadados"]["modelos"]["extrator"])
